...
const AssignFacultyToSubject = () => {
    ...
    const fetchSubjects = async () => {
        try {
            const response = await axios.get('https://attendance-management-system1.onrender.com/api/subjects/getAllUnAssignedSubjects');
    ...
    const handleAssignFaculty = async () => {
        ...
        try {
            ...
            const response = await axios.put(`https://attendance-management-system1.onrender.com/api/subjects/${selectedSubject}`, payload);
