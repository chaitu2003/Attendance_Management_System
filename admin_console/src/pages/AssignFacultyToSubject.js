...
const AssignFacultyToSubject = () => {
    ...
    const fetchSubjects = async () => {
        try {
            const response = await axios.get('http://attendance-management-system1.onrender.com/api/subjects/getAllUnAssignedSubjects');
    ...
    const fetchFaculties = async () => {
        try {
            const response = await axios.get('http://attendance-management-system1.onrender.com/api/faculty/');
    ...
    const handleAssignFaculty = async () => {
        ...
        try {
            ...
            const response = await axios.put(`http://attendance-management-system1.onrender.com/api/subjects/${selectedSubject}`, payload);
